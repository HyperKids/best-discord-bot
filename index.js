...
bot.on("messageReactionAdd", function (reaction) {
  ...
  if (reaction.d.message_id == "605212454603194391") {
    ...
    let userobj = user_reacts.find(
      ({ userID }) => userID == reaction.d.user_id
    );
...
function noperm(channelID, id) {
  bot.sendMessage({
    ...
    embed: {
      ...
      footer: {
        icon_url:
          "https://cdn.discordapp.com/icons/442754791563722762/a_ba9348709f6497c2dafc6220097de0ff.webp?size=128",
